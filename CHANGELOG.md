...
-   Synchronized `src/version.js` with the current release version.

## [1.6.0] - 2026-02-18

### Added

-   Added a deterministic moving platform with wrap mode.
-   Enhanced elevated platforms 2 and 3 to move in opposite directions for increased difficulty.
-   Moved horizontal platforms to better align with level design.
