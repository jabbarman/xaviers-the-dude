...
export class PortalScene extends Phaser.Scene {
  ...
  create() {
    ...
    const portal = this.add
      .circle(width / 2, height / 2, 10, 0x66ccff, 0.9)
      .setDepth(5001);
    const ring1 = this.add
      .circle(width / 2, height / 2, 30, 0x33aaff, 0.6)
      .setStrokeStyle(2, 0xffffff, 0.8)
      .setDepth(5001);
    const ring2 = this.add
      .circle(width / 2, height / 2, 60, 0x1188ff, 0.3)
      .setStrokeStyle(2, 0xffffff, 0.5)
      .setDepth(5001);

    // Text banner
    const text = this.add
      .bitmapText(width / 2, height / 2 - 100, 'arcade', 'PORTAL JUMP!', 24)
      .setOrigin(0.5)
      .setTint(0x00ffff)
      .setDepth(5002);
    ...
    this.time.delayedCall(1300, () => {
      ...
      } catch (e) { console.warn(`Error stopping scene ${this.from}:`, e); }
