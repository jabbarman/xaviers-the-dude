export class Preloader extends Phaser.Scene {
    ...
    preload() {
        ...
        // Audio
        this.load.audio('boden', 'assets/audio/bodenstaendig_2000_in_rock_4bit.mp3');
        ...
        this.load.audio('flat8bit', 'assets/audio/flat-8-bit-gaming-music-instrumental-211547.mp3')
        this.load.audio('8bitTheme', 'assets/audio/8bit-theme-loop-chiptune-symphony-387749.mp3');
        this.load.audio('percussiveDubstep', 'assets/audio/percussive-dubstep-chiptune-218126.mp3');
