...
export function setupFullscreen(scene) {
  ...
  scene.events.once('shutdown', () => {
    ...
    } catch (e) { console.warn('Error removing fullscreen button listeners:', e); }
    try {
      FKey.removeAllListeners();
    } catch (e) { console.warn('Error removing FKey listeners:', e); }
    try {
      hint.destroy();
    } catch (e) { console.warn('Error destroying fullscreen hint:', e); }
  });
